...
//public class JdbcUserDaoImplTest extends DataSourceBasedDBTestCase {
//
//
//    public static final String JDBC_TEST_PROPERTIES = "jdbc-test.properties";
//    private static JdbcUserDaoImpl jdbcUserDao;
...
//        connectionManager = ConnectionManager.getInstance(DBPoolConfig.getInstance(JDBC_TEST_PROPERTIES));
//        dataSource = connectionManager.getDataSource();
//        jdbcUserDao = new JdbcUserDaoImpl(connectionManager);
//    }
//
//    @Override
