...
<div class="container">
  <div class="row justify-content-center align-items-center m-1" style="min-height: 100vh">
    <form class="col-md-6 col-lg-4 text-left border border-dark p-3 px-lg-2 clearfix" action="${pageContext.request.contextPath}/login" method="post">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-8 col-lg-9 col-xl-10">
          <input type="password" class="form-control" id="exampleInputPassword1" aria-describedby="pass" placeholder="4657512" name="password">
        </div>
      </div>
