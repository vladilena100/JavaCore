...
<form method="post" action="">
    ...
    <label><input type="text" name="Login" disabled></label>Login<br>

    <label><input type="password" name="Password"></label>Password<br>

    <label><input type="password" name="PasswordAgain"></label>Password again<br>

    <label><input type="text" name="Email" required></label>Email<br>
