...
public class JdbcRoleDaoImpl implements DaoRole {

    private static final Logger LOG = LogManager.getLogger(JdbcRoleDaoImpl.class);

    private final ConnectionManager connectionManager;

    public JdbcRoleDaoImpl(ConnectionManager connectionManager) {
